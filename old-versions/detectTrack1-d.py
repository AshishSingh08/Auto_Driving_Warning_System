# adding and removal of cars after tracking (using mid-values)
...
while True:
    ...
    for i in curr:
        ...
        prev_frame.append([i[4],i[5],number,0])
    ...
    if number==0:
        for i in curr_frame:
            ...
            prev_frame.append([cx,cy,number,0])
    ...
    for ch in change:
        ...
        for rr,ob in enumerate(prev_frame):
            if ob[2]==find:
                prev_frame[rr][0],prev_frame[rr][1],prev_frame[rr][3]=ch[0],ch[1],0
                break
